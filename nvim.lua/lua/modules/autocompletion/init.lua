require'compe'.setup {
    ...
    max_kind_width = 100,
    max_menu_width = 100,
    documentation = {border = "rounded", max_width = 120, min_width = 60, max_height = math.floor(vim.o.lines * 0.3), min_height = 1},

    source = {path = true, buffer = true, calc = true, nvim_lsp = true, nvim_lua = true, vsnip = true, ultisnips = true}
}

-- Begin: Enable usage of TAB completion/selection
...
-- End: Enable usage of TAB completion/selection
--
-- Keymappings for TAB selection
...
vim.api.nvim_set_keymap("i", "<C-e>", "compe#scroll({'delta':-4})", {noremap = true, expr = true, silent = true})
